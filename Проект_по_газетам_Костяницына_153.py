#  В гитхабе лежат три кода. Свой первоначальный код я решила его немного переделать. Новый код состоит из 2 частей.
# сначала свою работу должна сделать эта программа, а потом уже вторая (продолжение)
import re
import os
